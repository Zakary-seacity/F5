...
{	
	...
	["gtacross"] =
	{
		["label"] = "Acitvation par défaut - GTA (1 = OFF)",
		["allValues"] = {false, true},
		["currentValue"] = 2,
	},
	["color"] =
...
local function SaveDatas()
	...
	notify("~y~Vous avez sauvegardé les modifications !", 5000)
end
...
local function ResetDatas()
	...
	notify("~y~Vous avez rénitialisé le viseur !", 5000)
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if customCrosshairState or isEditing then
			Citizen.Wait(0)
		else
			Citizen.Wait(500)
		end
