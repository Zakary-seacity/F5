...
ESX.RegisterServerCallback("ademo_inventory:Info", function(source, cb)
    local _src = source
...
ESX.RegisterServerCallback('ademo_inventory:billing', function(source, cb)
...
RegisterServerEvent('ademo_inventory:promouvoirplayer')
AddEventHandler('ademo_inventory:promouvoirplayer', function(target)
...
RegisterServerEvent('ademo_inventory:destituerplayer')
AddEventHandler('ademo_inventory:destituerplayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('ademo_inventory:recruterplayer')
AddEventHandler('ademo_inventory:recruterplayer', function(target, job, grade)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('ademo_inventory:virerplayer')
AddEventHandler('ademo_inventory:virerplayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('AdemoInve:ll')
AddEventHandler('AdemoInve:ll', function(plyId, value, quantity)
	if #(GetEntityCoords(source, false) - GetEntityCoords(plyId, false)) <= 3.0 then
		TriggerClientEvent('Ademo:ii', plyId, value, quantity)
	end
end)